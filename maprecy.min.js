...
},{}],"maprecy":[function(require,module,exports){
module.exports=require('cFmARE');
},{}],"cFmARE":[function(require,module,exports){
var ls=function(a){console.log(util.inspect(a,{depth:null}))};exports.setup=function(a){var e=require("./jquery.js");require("./jquery.csv.js");var o={opts:a};return o.template=e("<div></div>"),o.fill=function(){window.display_maprecy_map=function(){var a,e,t,n={center:new google.maps.LatLng(53.7997,-1.5492),zoom:16,scrollwheel:!0},l=new google.maps.Map(document.getElementById("map"),n),s=function(){e&&e.setMap(null);var t=o.data,n=function(a){return Math.floor(1e4*a)};o.heatmap={};var s=o.heatmap,p=t.codes[o.mode],r=t.dumps[o.mode],i=0;for(var m in p)for(var c=0;c<p[m].length;c++){var u=p[m][c],d=n(u.lat);s[d]=s[d]||{};var g=s[d],d=n(u.lng),v=u.weight*(r[m]||0);g[d]=(g[d]||0)+v,i+=v}console.log(o.heatmap),a=[];for(var h in o.heatmap)for(var f in o.heatmap[h])a.push({location:new google.maps.LatLng(h/1e4,f/1e4),weight:o.heatmap[h][f]||0});e=new google.maps.visualization.HeatmapLayer({data:a}),e.setMap(l)};window.display_heatmap=s,o.mode="black",s();var p=function(){var a=1*Math.pow(2,l.getZoom())/256;4>a&&(a=4),a>256&&(a=0),t||e&&e.setOptions({radius:a})};google.maps.event.addListener(l,"zoom_changed",p),p()},head.js("https://maps.googleapis.com/maps/api/js?key=AIzaSyDPrMTYfR7XcA3PencDS4dhovlILuumB_w&libraries=visualization&sensor=false&callback=display_maprecy_map")},e(function(){e.ajax({type:"GET",url:"maprecy.json",dataType:"json",success:function(a){o.data=a,console.log(a),o.template.load("maprecy.template.html",o.fill)}})}),o};
},{"./jquery.csv.js":1,"./jquery.js":2}],5:[function(require,module,exports){
module.exports=require(2)
},{}]},{},[])


//# sourceMappingURL=maprecy.map.json